...
class LocalBackend(Backend):
    ...
    def _get_packed_tensors(
        ...
        tokenized_results = list(
            tokenize_trajectory_groups(
                ...
                skip_advantage_filter=skip_advantage_filter,
            )
        )
    ...
    async def train(  # type: ignore[override]
        ...
        *,
        ...
        # Verbosity
        verbose: bool = False,
        # Force training even when all rewards are equal (for benchmarking)
        skip_advantage_filter: bool = False,
    ) -> LocalTrainResult:
    ...
    async def _train_model(
        ...
        packed_tensors = self._get_packed_tensors(
            ...
            skip_advantage_filter=dev_config.get("skip_advantage_filter", False),
        )
