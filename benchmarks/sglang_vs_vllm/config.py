"""
Benchmark configuration for SGLang + Megatron vs vLLM + Megatron vs Unsloth + SGLang.

All parameters that control the benchmark are defined here to ensure
all backends are tested under identical conditions.
"""
...
class BenchmarkConfig:
    ...
    backends: list[Literal["vllm", "sglang", "unsloth"]] = field(
